...
import { BookOpen, FileText, Plus, Search, Filter, Layers, Loader2, AlertCircle } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredSets.length === 0 ? (
                ...
                filteredSets.map((set, i) => (
                  <div
                    key={set.id}
                    className="group p-5 rounded-2xl border border-slate-100 hover:border-indigo-200 hover:shadow-lg transition-all"
                  >
            ...
            <div className="space-y-4">
              {filteredQuestions.length === 0 ? (
                ...
                filteredQuestions.map((q) => (
                  ...
                  >
                    <p className="text-sm text-slate-900 line-clamp-2">{q.content}</p>
