      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="divide-y divide-slate-100">
          {[
            {
              user: 'alex_dev',
              action: 'Created new question set "Advanced React"',
              time: '2 mins ago',
              icon: <CheckCircle2 className="text-emerald-500" size={16} />,
            },
            {
              user: 'mod_jess',
              action: 'Resolved report #9842 (Inaccurate content)',
              time: '14 mins ago',
              icon: <CheckCircle2 className="text-emerald-500" size={16} />,
            },
            {
              user: 'system',
              action: 'Auto-blocked user "bot_99" for suspicious activity',
              time: '1 hour ago',
              icon: <Clock className="text-slate-400" size={16} />,
            },
            {
              user: 'sarah_smith',
              action: 'Reported question #772 (Spam)',
              time: '3 hours ago',
